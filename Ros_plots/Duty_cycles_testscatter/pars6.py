# set pars for z=0.45, Reines&Volonteri15, testing duty cycle: Georgakakis+17
...
methods={'halo_to_stars':'Grylls19', # 'Grylls19' or 'Moster'
    ...
    'BH_mass_scatter':0.8, # "Intrinsic" or float
...
################################
# filename suffix
suffix=f"_Georgakakis17_scatter{methods['BH_mass_scatter']}"
