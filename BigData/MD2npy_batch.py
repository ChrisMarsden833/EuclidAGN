...
files = ["hlist_0.33030.list", "hlist_0.40320.list", "hlist_0.50320.list", "hlist_0.65650.list", "hlist_0.80130.list", "hlist_0.91520.list"]
...
for fname_input in files:
    ...
    hlist = ["x", "y", "z", "Acc_Scale", "Macc", "M200c", "upid", "id"]
