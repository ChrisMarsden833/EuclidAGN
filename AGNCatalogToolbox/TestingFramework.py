...
class AGNCatalog:
    ...
    def __init__(self, cosmo='planck18', print_updates=True):
        ...
        self.path_visual_validation = utl.ValidatePath("./visualValidation/")
    ...
    def load_dm_catalog(self, volume_axis=1000, visual_debugging=False, filename="MD_", path_big_data="./BigData/"):
        ...
        effective_halo_mass, effective_z, virial_mass, up_id, x, y, z =\
            main.load_halo_catalog(self.h, self.z, self.cosmology,
                                  filename=filename,
    ...
    def generate_semi_analytic_halos(self, volume=500**3, mass_low=12., mass_high=16., visual_debugging=False):
        ...
        temporary_halos = \
            main.generate_semi_analytic_halo_catalogue(catalogue_volume=volume,
    ...
    def assign_duty_cycle(self, function="Man16", suppress_output=False):
    ...
    def assign_luminosity(self, method="Schechter", redshift_evolution=False, parameter1=-1, parameter2=-0.65):
        ...
        self.main_catalog['luminosity'], xlf_plotting_data, edd_plotting_data = \
            main.black_hole_mass_to_luminosity(self.main_catalog["black_hole_mass"],
